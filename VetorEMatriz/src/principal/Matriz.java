...
public class Matriz {
	...
	public static void main(String[] args) {
		//uma matriz é um vetor multidimensional geralmente trabalhamos com 2 dimensões
		 ...
		 * 
		 * 2) fazer uma matriz 4x4 para inserir nome e as 4 notas do aluno, não precisa mostrar a média.
		 */
